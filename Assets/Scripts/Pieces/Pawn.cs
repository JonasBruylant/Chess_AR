...
public class Pawn : Piece
{
    ...
    {
        int endOfBoardYCoords = team == TeamColor.White ? Board.BOARD_SIZE - 1 : 0;

        if (occupiedSquare.y == endOfBoardYCoords)
            ChessGameController.Instance.PawnWantsToPromote(this);
